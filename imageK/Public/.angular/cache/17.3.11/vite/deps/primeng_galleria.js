import {
  WindowMaximizeIcon,
  WindowMinimizeIcon
} from "./chunk-L3X3NFBM.js";
import {
  FocusTrap,
  FocusTrapModule
} from "./chunk-6V7QWJBR.js";
import {
  platformBrowser
...
function Galleria_div_0_div_2_p_galleriaContent_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext(3);
    ɵɵproperty("@animation", ɵɵpureFunction1(8, _c4, ɵɵpureFunction2(5, _c3, ctx_r1.showTransitionOptions, ctx_r1.hideTransitionOptions)))("value", ctx_r1.value)("activeIndex", ctx_r1.activeIndex)("numVisible", ctx_r1.numVisible)("ngStyle", ctx_r1.containerStyle);
  }
}
...
function Galleria_ng_template_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ɵɵproperty("value", ctx_r1.value)("activeIndex", ctx_r1.activeIndex)("numVisible", ctx_r1.numVisible);
  }
}
var _c5 = ["closeButton"];
var _c6 = (a0, a1, a2) => ({
